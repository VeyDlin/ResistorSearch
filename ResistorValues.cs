...
public struct ResistorValues {
    ...
    static public List<double> E6 = new() { 
        1.0, 1.5, 2.2, 3.3, 4.7, 6.8 
    };

    static public List<double> E12 = new() { 
        1.0, 1.2, 1.5, 1.8, 2.2, 2.7, 3.3, 3.9, 4.7, 5.6, 6.8, 8.2 
    };

    static public List<double> E24 = new() { 
        1.0, 1.1, 1.2, 1.3, 1.5, 1.6, 1.8, 2.0, 2.2, 2.4, 2.7, 3.0,
        3.3, 3.6, 3.9, 4.3, 4.7, 5.1, 5.6, 6.2, 6.8, 7.5, 8.2, 9.1 
    };
    
    static public List<double> E48 = new() { 
    ...
    static public List<double> E96 = new() { 
    ...
    static public List<double> E192 = new() { 
